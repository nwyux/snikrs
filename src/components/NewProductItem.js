      ...
      <div className="flex flex-col justify-center items-center">
        ...
        >
          {filterItems.map((item) => (
            <SplideSlide key={item.id} className="w-ful max-w-xs sm:max-w-none max-h-lg font-horizonbig ">
              <div className="flex justify-center items-center">
                <div className="flex flex-col w-4/6 sm:w-auto justify-center items-center border-2 border-noir rounded">
                  ...
                  <div className="flex justify-center items-center gap-2 py-2">
                    <button className="bg-noir text-blanc py-2 px-2 rounded-lg text-xs">
                      ADD TO CART
                    </button>
                    <button className="border-2 border-noir text-noir py-2 px-2 rounded-lg text-xs transition-all duration-150 hover:bg-noir hover:text-blanc">
                      BUY NOW
                    </button>
                  </div>
                </div>
